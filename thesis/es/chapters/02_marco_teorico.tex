...
\parencite{currie2010gaps}. El marco las reformula como una cantidad continua ponderada por
demanda y, dado que demanda y oferta se construyen de forma independiente, produce una
variable dependiente que un modelo supervisado puede aprender sin memorizar simplemente la
red existente.
...
por la entropía de Shannon \parencite{shannon1948}. Ambos son basados en datos: leen los
pesos de la propia matriz de indicadores, lo que hace la priorización reproducible y, sobre
todo, re-derivable desde cero en una ciudad nueva sin volver a elicitar juicios de expertos.
...
\parencite{guihaire2008, farahani2013review}. La tradición heurística relevante es el árbol
...
parientes usada aquí. Estas heurísticas resultan atractivas para la generación de corredores
